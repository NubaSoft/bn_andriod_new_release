...
const MealItem: React.FC<MealItemProps> = ({ index, item, onPress, styleContainer }) => {
  const DETAILS: any = [
    {
      id: 1,
  ...
  return (
    <TouchableOpacity onPress={onPress} style={[styles.container, styleContainer]} key={index}>
