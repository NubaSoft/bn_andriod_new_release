...
import { verifyResetOtpCode } from "../../../middleware/authentication/forgetPassword"
import { useSelector } from "react-redux"

const VerificationCode: React.FC<{}> = (params: any) => {
  ...
  const bodySection = () => {
    const onVerificationCode = () => {
      if (data?.otpCode != OTPCode) {
        ...
        dispatch(
          verifyResetOtpCode({ mobileNumber: data?.mobileNumber, otpCode: OTPCode, navigation }),
        )
      }
    }
